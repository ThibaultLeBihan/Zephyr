...
echo_and_run cd "/home/hydrosharks2/workspaceRos/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/hydrosharks2/workspaceRos/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/hydrosharks2/workspaceRos/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
